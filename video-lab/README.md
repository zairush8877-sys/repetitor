...
Новый банк ЕГЭ/ОГЭ: `exam-bank.json`, композиции `Exam-*` в `remotion/src/Exam.tsx`.
Готовые 14 выпусков и 14 пар Stories — `outputs/exam-bank-2026-09-26/` от корня.
Они изолированы, `pending`, без дат. Фактический экспорт этой серии выполнен
Pillow/FFmpeg; описание прежнего Remotion-экспорта ниже относится к банку 20–25 сентября.
Полные инструкции и ограничения: `docs/EXAM-BANK-PACKAGING.md` от корня репозитория.
...
Актуальный банк использует новые полноэкранные фотосцены ImageGen:
`assets/photos/photo-v3/`, промпты и происхождение — `prompts.json` в этой папке.
Это иллюстрации, а не личные документальные фотографии преподавателя.
Правка оформления и сравнение версий: `design/PHOTO_REFRESH_2026-09-19.md`
и `outputs/photo-refresh-2026-09-19/index.html`.
